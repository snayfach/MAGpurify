...
def flag_contigs(db_dir, tmp_dir, args):
	...
	bin = Bin()
	bin.genes = {}
	hmm_path = "%s/phyeco.hmmsearch" % args['tmp_dir']
	...
	for seq_type in seq_types:
		for marker_id in markers:
			aln_path = args['tmp_dir']+"/alns/"+marker_id+"."+seq_type+".m8"
...
def main(args):
	...
	run_prodigal(args['fna_path'], args['tmp_dir'])

	sys.stderr.write("running hmmsearch\n")
	run_hmmsearch(args['db'], args['tmp_dir'], args['threads'])
	...
	flagged_contigs = flag_contigs(args['db'], args['tmp_dir'], args)
